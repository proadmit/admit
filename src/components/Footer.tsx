      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="text-sm text-gray-600">
            ...
            <Link href="/privacy-policy" className="hover:text-gray-900 ml-2">Privacy Policy</Link>
            <Link href="/terms-of-use" className="hover:text-gray-900 ml-2">Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
